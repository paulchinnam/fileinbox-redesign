            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                <div className="space-y-2 py-6">
                  {navigation.map((item) => (
                    <Link
                      key={item.name}
                      href={item.href}
                      className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-blue-400 hover:text-white"
                    >
                      {item.name}
                    </Link>
                  ))}
                ...
                <div className="py-6">
                  <Link
                    href="/login"
                    className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-blue-400 hover:text-white"
                  >
                    Log in
                  </Link>
                </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600 max-w-xl">
              Fileinbox makes it easy to build file upload form pages so you can
              receive documents, photos, and videos from your clients. Uploaded
              files go straight to your email, Dropbox, or Google Drive.
            </p>
      ...
      {/* <div className="relative isolate pt-14">
        ...
        <div className="py-24 sm:py-32 lg:pb-40">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mt-16 flow-root sm:mt-0">
              <Image
                src={macbook2}
                alt="App screenshot"
                width={2432}
